<?php
/**
 * 🔄 CHANNEL archiv BIDIREKTIONALE SYNCHRONISATION (MadelineProto)
 * ================================================================
 * 
 * Synchronisiert Chat-Nachrichten zwischen:
 * - Telegram-Chat (@ArchivWeltenBibliothek) ↔ Flutter-App (Firestore)
 * 
 * Features:
...
// Telegram Chat
$CHAT_USERNAME = '@ArchivWeltenBibliothek';
...
$FTP_PASS = 'Jolene2305';
$FTP_REMOTE_PATH = '/archiv/';  // Chat-Ordner im FTP
$HTTP_BASE_URL = "http://{$FTP_HOST}:8080/archiv";  // HTTP-URL für Chat-Ordner

// Firebase
$FIREBASE_SDK = '/opt/flutter/firebase-admin-sdk.json';
$FIRESTORE_COLLECTION = 'archiv_messages';
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║  🔄 CHANNEL archiv BIDIREKTIONALE SYNCHRONISATION         ║\n";
