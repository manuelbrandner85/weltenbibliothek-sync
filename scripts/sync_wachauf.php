<?php
/**
 * 🔄 CHANNEL wachauf BIDIREKTIONALE SYNCHRONISATION (MadelineProto)
 * ================================================================
 * 
 * Synchronisiert Chat-Nachrichten zwischen:
 * - Telegram-Chat (@WeltenbibliothekWachauf) ↔ Flutter-App (Firestore)
 * 
 * Features:
...
// Telegram Chat
$CHAT_USERNAME = '@WeltenbibliothekWachauf';
...
$FTP_PASS = 'Jolene2305';
$FTP_REMOTE_PATH = '/wachauf/';  // Chat-Ordner im FTP
$HTTP_BASE_URL = "http://{$FTP_HOST}:8080/wachauf";  // HTTP-URL für Chat-Ordner

// Firebase
$FIREBASE_SDK = '/opt/flutter/firebase-admin-sdk.json';
$FIRESTORE_COLLECTION = 'wachauf_messages';
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║  🔄 CHANNEL wachauf BIDIREKTIONALE SYNCHRONISATION         ║\n";
