<?php
/**
 * 🔄 CHANNEL pdfs BIDIREKTIONALE SYNCHRONISATION (MadelineProto)
 * ================================================================
 * 
 * Synchronisiert Chat-Nachrichten zwischen:
 * - Telegram-Chat (@WeltenbibliothekPDF) ↔ Flutter-App (Firestore)
 * 
 * Features:
...
// Telegram Chat
$CHAT_USERNAME = '@WeltenbibliothekPDF';
...
$FTP_PASS = 'Jolene2305';
$FTP_REMOTE_PATH = '/pdfs/';  // Chat-Ordner im FTP
$HTTP_BASE_URL = "http://{$FTP_HOST}:8080/pdfs";  // HTTP-URL für Chat-Ordner

// Firebase
$FIREBASE_SDK = '/opt/flutter/firebase-admin-sdk.json';
$FIRESTORE_COLLECTION = 'pdf_messages';
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║  🔄 CHANNEL pdfs BIDIREKTIONALE SYNCHRONISATION         ║\n";
