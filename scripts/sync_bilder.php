<?php
/**
 * 🔄 CHANNEL bilder BIDIREKTIONALE SYNCHRONISATION (MadelineProto)
 * ================================================================
 * 
 * Synchronisiert Chat-Nachrichten zwischen:
 * - Telegram-Chat (@weltenbibliothekbilder) ↔ Flutter-App (Firestore)
 * 
 * Features:
...
// Telegram Chat
$CHAT_USERNAME = '@weltenbibliothekbilder';
...
$FTP_PASS = 'Jolene2305';
$FTP_REMOTE_PATH = '/images/';  // Chat-Ordner im FTP
$HTTP_BASE_URL = "http://{$FTP_HOST}:8080/images";  // HTTP-URL für Chat-Ordner

// Firebase
$FIREBASE_SDK = '/opt/flutter/firebase-admin-sdk.json';
$FIRESTORE_COLLECTION = 'bilder_messages';
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║  🔄 CHANNEL bilder BIDIREKTIONALE SYNCHRONISATION         ║\n";
